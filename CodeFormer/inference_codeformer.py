...
if __name__ == '__main__':
    ...
    elif args.input_path.endswith(('mp4', 'mov', 'avi', 'webm', 'mkv','mov', 'wmv')): # input video path
        input_img_list = []
    ...
    if input_video:
        ...
        save_restore_path = os.path.join(result_root, f'{video_name}.mp4').replace("..mp4",".mp4")
